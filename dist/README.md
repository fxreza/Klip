...
The single **last live** build - always the same files as the newest folder in `releases/`.
Overwritten on every release. Install from here; use `releases/` for rollback.
