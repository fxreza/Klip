...
enum ShortcutTests {
    ...
    static func testDefaultsMatchGlobalKeyMonitor() throws {
        ...
        try expectEqual(ShortcutAction.star.defaultBinding, KeyBinding(keyCode: 11, modifiers: [.command]), "star = Cmd+B")
        ...
        try expectEqual(ShortcutAction.nextScope.defaultBinding, KeyBinding(keyCode: 30, modifiers: [.command]), "nextScope = Cmd+]")
        try expectEqual(ShortcutAction.previousScope.defaultBinding, KeyBinding(keyCode: 33, modifiers: [.command]), "previousScope = Cmd+[")
    ...
    static func testConflictDetection() throws {
        ...
        // .pin defaults to Cmd+P; try to also bind .star to Cmd+P.
